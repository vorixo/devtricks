...
- Killcam sample code by Epic. [download](https://forums.unrealengine.com/uploads/short-url/8HbkXKZGbi2g383QZYzbw1PCLUa.zip). Add the header and the cpp file to your Lyra project. Ensure you change the `Pawn` and `PlayerState` references you'll find in the source code so it compiles.
