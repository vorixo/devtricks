...
This post isn't a tutorial about the [Enhanced Input Plugin](https://docs.unrealengine.com/4.26/en-US/InteractiveExperiences/Input/EnhancedInput/), so I encourage readers to explore further on how its interface works. However, for the sake of completion I'll highlight here some features from the plugin that are relevant for this post:
