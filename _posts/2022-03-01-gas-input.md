...
As we can see above, `OnGiveAbility` is called when the local client receives the ability so, it can start manipulating it locally, therefore binding them to an InputAction.
