...
Setting up GAS involves writing hundreds of boilerplate lines of code. Literally hundreds. The system is not really plug-and-play, although some Epic staff have recently commented that they would like to do the setup more user friendly so that people can start using the system without spending hours adding initialization code.
