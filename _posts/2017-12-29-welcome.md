...
[ShooterGame](https://docs.unrealengine.com/en-us/Resources/SampleGames/ShooterGame){:target="_blank"} is a very great project **Epic Games** has available as a learning resource for Unreal Engine 4. In 2016 I started SGE, which adds a whole bundle of features to ShooterGame to extends its purpose. 
