...
My first year using the engine was mainly based on learning the engine capabilities and getting used to the framework. **Blueprints** were extremely useful for that, since they give you a notion of what **UE4** is able to pull of. Once I got used to the engine workflow I started applying that knowledge with **my first unreleased game**:
