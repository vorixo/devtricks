...
#undef TO
	...
	bool isAddressInMemoryRange(const unsigned char *addess) const;
	cMemoryChunk *findChunkForUserMemory(const unsigned char *address) const;
	void deallocateChunk(cMemoryChunk *chunk);
};
